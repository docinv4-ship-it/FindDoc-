...
function FeaturedDoctorsSection({ onOpenAuth }: { onOpenAuth: () => void }) {
    ...
    return (
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Loader2 className="w-8 h-8 animate-spin mx-auto text-[#36d1cf]" />
        </div>
      </section>
    );
  }
    ...
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div key={doctor.id} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow relative">
                ...
                <div className="p-6">
                  <div className="flex items-start gap-4">
                    <div className="w-16 h-16 rounded-full flex items-center justify-center flex-shrink-0 bg-teal-50">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm font-medium text-[#36d1cf]">{doctor.specialization}</p>
                    </div>
                  </div>
                  {clinic && (
                  ...
                  <button
                    onClick={onOpenAuth}
                    className="mt-4 w-full py-2.5 text-white font-medium rounded-lg transition-all hover:brightness-105 active:scale-[0.99] border-0 cursor-pointer"
        ...
        <div className="text-center mt-8">
          <button 
            onClick={onOpenAuth} 
            className="inline-flex items-center gap-2 text-sm font-medium hover:underline text-[#36d1cf] bg-transparent border-0 cursor-pointer"
          >
...
export default function LandingPage() {
    ...
    return (
      <div className="flex h-screen w-screen items-center justify-center bg-white">
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm font-bold text-gray-500 tracking-wide">Connecting to ClinicBook...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <Link href="/" className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center bg-[#36d1cf]">
                <Stethoscope className="w-6 h-6 text-white" />
              </div>
              <span className="text-2xl font-bold text-gray-900">DocFind</span>
            </Link>
            <nav className="hidden md:flex items-center gap-8">
              <button onClick={() => setIsAuthModalOpen(true)} className="text-gray-600 hover:text-gray-900 transition-colors bg-transparent border-0 cursor-pointer font-medium">Find a Doctor</button>
            ...
            <div className="flex items-center gap-4">
              <button onClick={() => setIsAuthModalOpen(true)} className="px-4 py-2 text-gray-600 hover:text-gray-900 font-medium transition-colors bg-transparent border-0 cursor-pointer">Find Doctors</button>
              ...
              <Link href="/doctor/signup" className="px-5 py-2 rounded-lg text-white font-medium transition-all hover:brightness-105 bg-[#36d1cf]">Join as Doctor</Link>
            </div>
          </div>
        </div>
      </header>
      ...
      <section className="relative overflow-hidden" style={{ background: "linear-gradient(135deg, #f0fffe 0%, #ffffff 100%)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium mb-6 bg-teal-50 text-teal-800">
                <Shield className="w-4 h-4 text-teal-600" />
                Trusted by 10,000+ patients
              </div>
              <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-tight">
                Book Appointments with Top Doctors
                <span className="text-[#36d1cf]"> Instantly</span>
              </h1>
              ...
              <div className="mt-10 flex flex-col sm:flex-row gap-4">
                <button 
                  ...
                  className="px-8 py-4 rounded-xl text-white font-semibold transition-all hover:brightness-105 text-center bg-[#36d1cf] border-0 cursor-pointer"
                >
                  Find a Doctor
                </button>
                <button 
                  onClick={() => setIsAuthModalOpen(true)} 
                  className="px-8 py-4 rounded-xl border-2 border-gray-200 text-gray-700 font-semibold transition-all hover:bg-gray-50 text-center bg-transparent cursor-pointer"
                >
                  My Appointments
                </button>
              </div>
              <div className="mt-8 flex items-center gap-8">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-10 h-10 rounded-full flex items-center justify-center bg-teal-50">
                    <Calendar className="w-5 h-5 text-[#36d1cf]" />
                  </div>
                  <div>
            ...
            <div className="hidden lg:block relative">
              <div className="relative bg-white rounded-2xl p-8 shadow-2xl shadow-gray-200/50 border border-gray-100">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-16 h-16 rounded-xl flex items-center justify-center bg-teal-50">
                ...
                <div className="space-y-3">
                  {["Dr. Sarah Johnson - Cardiology", "Dr. Michael Chen - Dermatology", "Dr. Emily Davis - Pediatrics"].map((doc, i) => (
                    <div key={i} className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer border border-gray-100">
                      ...
                      <span className="text-xs px-2 py-1 rounded-full font-medium bg-teal-50 text-teal-800">Available</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="bg-white p-8 rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow">
                <div className="w-14 h-14 rounded-xl flex items-center justify-center mb-6 bg-teal-50">
                  <feature.icon className="w-7 h-7 text-[#36d1cf]" />
                </div>
      ...
      <FeaturedDoctorsSection onOpenAuth={() => setIsAuthModalOpen(true)} />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <ul className="mt-8 space-y-4">
                {["Smart calendar with availability management", "Direct patient chat and follow-ups", "Analytics and patient insights", "Accept both manual and auto-confirmed bookings"].map((item, i) => (
                  <li key={i} className="flex items-center gap-3">
                    <div className="w-6 h-6 rounded-full flex items-center justify-center flex-shrink-0 bg-[#36d1cf]">
              ...
              <Link href="/doctor/signup" className="inline-flex items-center gap-2 mt-8 px-6 py-3 rounded-lg text-white font-semibold transition-all hover:opacity-90 bg-[#36d1cf]">
                Join as a Doctor <ArrowRight className="w-5 h-5" />
              </Link>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                <p className="text-4xl font-bold text-[#36d1cf]">98%</p>
                <p className="text-gray-600 mt-2">Patient Satisfaction</p>
              </div>
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                <p className="text-4xl font-bold text-[#36d1cf]">24/7</p>
                <p className="text-gray-600 mt-2">Online Booking</p>
              </div>
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                <p className="text-4xl font-bold text-[#36d1cf]">2min</p>
                <p className="text-gray-600 mt-2">Avg. Booking Time</p>
              </div>
              <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                <p className="text-4xl font-bold text-[#36d1cf]">100+</p>
      ...
      <section className="py-20 bg-[#36d1cf]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <button onClick={() => setIsAuthModalOpen(true)} className="px-8 py-4 bg-white rounded-lg font-semibold transition-colors hover:bg-gray-100 text-[#36d1cf] border-0 cursor-pointer">Find a Doctor</button>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-gray-400">
                <li><button onClick={() => setIsAuthModalOpen(true)} className="hover:text-white transition-colors bg-transparent border-0 cursor-pointer text-left text-gray-400 p-0 text-base">Find a Doctor</button></li>
                <li><button onClick={() => setIsAuthModalOpen(true)} className="hover:text-white transition-colors bg-transparent border-0 cursor-pointer text-left text-gray-400 p-0 text-base">Patient Portal</button></li>

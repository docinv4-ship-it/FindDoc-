...
export default function BookingPendingContent() {
      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden text-center">
          ...
          <div className="p-8">
            ...
            <p className="text-gray-600 mb-6">Your appointment request has been submitted. The doctor will review and confirm your booking shortly. You will be notified once confirmed.</p>
            ...
            <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-sm text-yellow-800">
                <strong>Note:</strong> This appointment is pending approval. Check back later or view your appointments to see the status.
              </p>
            </div>
